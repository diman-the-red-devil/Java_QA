...
***Подробное описание (Descriptions)*** - текст с более подробным описанием фичи.
...
**Подробное описание (Descriptions)** располагается на следующих строках после строки с ключевым словом и размечается отступами.
Количество строк никак не ограничено и **Подробное описание (Descriptions)** продолжается до первого встреченного ключевого слова.
