...
# 4. Объектная модель страницы - Page Object Model
...
## 4.4. Класс SmartphoneProductPage
...
![New Maven Project - SmartphoneProductPage.java](./_Files/2.%20New%20Project/15.jpg "New Project - SmartphoneProductPage.java")
...
![New Maven Project - tests](./_Files/2.%20New%20Project/16.jpg "New Project - tests")

2. Создать файл **BaseTest.java** в **./src/test/java/tests**.

![New Maven Project - BaseTest.java](./_Files/2.%20New%20Project/17.jpg "New Project - BaseTest.java")
...
## 5.2. Класс SmartphonesTest

***SmartphonesTest*** - класс содержащий тесты с проверками страницы **Продукт. Смартфон**.
Класс **SmartphonesProductPageTest** расширяет класс **BaseTest**.

Шаги:

1. Создать файл **SmartphonesProductPageTest.java** в **./src/test/java/tests**.

Класс **SmartphonesProductPageTest** расширяет класс **BaseTest**.

![New Maven Project - SmartphonesProductPageTest.java](./_Files/2.%20New%20Project/18.jpg "New Project - SmartphonesProductPageTest.java")

2. Добавить в файл **SmartphonesProductPageTest.java** код.
...
public void selectedProduct_Is_SamsungGalaxyNote20Ultra256GBWhite() {
    ...
    Assertions.assertEquals(expected, smartphoneProductPage.getPageTitle());
}
```

## 5.3. Запуск автотеста

Шаги:

1. Запустить тест командой **mvn clean test** с параметром **-Dbrowser=chrome**.
