...
4. Создать класс **BasePage.java** в **./src/test/java/pageobjects**.

![New Maven Project - BasePage.java](./_Files/2.%20New%20Project/08.jpg "New Project - BasePage.java")

5. Добавить в файл **BasePage.java** код.
...
6. Создать класс **BasePage.java** в **./src/test/java/pageobjects**.

![New Maven Project - BasePage.java](./_Files/2.%20New%20Project/08.jpg "New Project - BasePage.java")

7. Добавить в файл **BasePage.java** код.
