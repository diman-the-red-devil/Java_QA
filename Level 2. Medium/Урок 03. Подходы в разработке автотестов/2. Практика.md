...
выполняемыми до и после исполнения сценариев описанных в **.feature** файлах.
...
3.2. Создать пакет Java **elements** в папке **./src/test/java/web**.

В данном пакете будут находиться **.java** файлы с веб элементами.

3.3. Создать пакет Java **pages** в папке **./src/test/java/web**.
