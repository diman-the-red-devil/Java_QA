...
## 4.4. Полный код ActionHelper.java
...
![New Maven Project - MainBlock.java](./_Files/2.%20New%20Project/30.jpg "New Project - MainBlock.java")
...
![New Maven Project - Table.java](./_Files/2.%20New%20Project/31.jpg "New Project - Table.java")
...
![New Maven Project - SmartphonesPage.java](./_Files/2.%20New%20Project/34.jpg "New Project - Smartphones.java")
...
![New Maven Project - SmartphoneProductPage.java](./_Files/2.%20New%20Project/35.jpg "New Project - SmartphoneProductPage.java")
...
![New Maven Project - Ram.java](./_Files/2.%20New%20Project/36.jpg "New Project - Ram.java")
...
![New Maven Project - Company.java](./_Files/2.%20New%20Project/37.jpg "New Project - Company.java")
...
![New Maven Project - Smartphone.java](./_Files/2.%20New%20Project/38.jpg "New Project - Smartphone.java")
...
![New Maven Project - Smartphone.feature](./_Files/2.%20New%20Project/39.jpg "New Project - Smartphone.feature")
...
![New Maven Project - SmartphoneSteps.java](./_Files/2.%20New%20Project/40.jpg "New Project - SmartphoneSteps.java")
...
public void startDriverAndOpenStartPage() {
    // Заглушка - ожидание реализации
    throw new PendingException();
}
```

* метод **openSmatphonesPage** - шаг **Когда** *Выполнен переход на страницу Смартфоны*
...
[SmartphoneSteps.feature](_Sample_03/src/test/java/steps/SmartphoneSteps.java)
...
# 12. Выполнение тестовых сценариев
