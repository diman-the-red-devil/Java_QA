...
public class SignInPage {
    ...
    // Вход с логином и паролем
    public HomePage loginValidUser(LoginJB loginJB) {
        TextBox tbxLogin = new TextBox(driver, loginBy);
        tbxLogin.setValue(loginJB.getLogin());
        TextBox tbxPassword = new TextBox(driver, passwordBy);
        tbxPassword.setValue(loginJB.getPassword());
        Button btnSignIn = new Button(driver, signInBy);
        btnSignIn.click();
        return new HomePage(driver);
    }
...
public class LoginTest {
    ...
    public void loginTest() {
        ...
        String login = "diman_the_red_devil@mail.ru";
        String password = "JAKARTA12345rex-";
        LoginJB loginJB = new LoginJB(login, password);
        String expected = "Dashboard";
    
        // Act
        HomePage homePage = getPageAfterLogin(loginJB);
    ...
    public HomePage getPageAfterLogin(LoginJB loginJB) {
        // Страница "Sign In"
        SignInPage signInPage = new SignInPage(driver);
        // Вход с логином и паролем
        // Страница "Home"
        return signInPage.loginValidUser(loginJB);
    }
    ...
}
```
...
3. *Класс учетных данных - Account*
...
4. *Класс страницы (Page Object) - SignInPage*
