...
#### 3.1.1.8. Что изменилось и какая польза?
...
А что тогда делать в этом случае? Создавать +100500 конструкторов на все случаи жизни?
...
## 4.2. Паттерн Легковес (Flyweight / Object Pool)
