...
## 1.1.2. Получение справки по опциям командной строки Cucumber

***--help*** или ***-h*** - получение справки по опциям командной строки **Cucumber**.
...
## 1.1.3. Указание пакетов Java с кодом шагов, хуков и т д.

***--glue*** или ***-g*** - указание пакетов **Java** с кодом шагов, хуков и т д.
...
## 1.1.4. Задание количества параллельных потоков при запуске сценариев

***--threads*** - задание количество параллельных потоков при запуске сценариев.
...
## 1.1.5. Подключение плагинов

***--plugin*** или ***-p*** - подключение плагинов.
...
```text
java io.cucumber.core.cli.Main @<path>/<file>
```
...
[Cucumber Core](https://github.com/cucumber/cucumber-jvm/tree/main/core#properties-environment-variables-system-options)

### 2.1.1. Указание пакетов Java с кодом шагов, хуков и т д.

***cucumber.glue*** - указание пакетов **Java** с кодом шагов, хуков и т д.
...
### 2.1.2. Указание папок с фичами и сценариями

***cucumber.features*** - указание папок с фичами и сценариями.
...
### 2.1.3. Подключение плагинов

***cucumber.plugin*** - подключение плагинов.
...
[Cucumber JUnit Platform Engine](https://github.com/cucumber/cucumber-jvm/tree/main/junit-platform-engine#configuration-options)

## 2.2.1. Указание пакетов Java с кодом шагов, хуков и т д.

cucumber.glue=                                                # comma separated package names.
example: com.example.glue

*** *** - указание пакетов **Java** с кодом шагов, хуков и т д.
...
## 2.2.5. Запуск сценариев без выполнения кода шагов сценариев

cucumber.execution.dry-run=                                   # true or false.
default: false

*** *** - запуск сценариев без выполнения кода шагов сценариев.
...
## 2.2.6. Черно-белый / цветной вывод в консоль

cucumber.ansi-colors.disabled=                                # true or false. default: false

*** *** - черно-белый / цветной вывод в консоль.
...
## 2.2.7. Стиль именования для сгенерированных методов

cucumber.snippet-type=                                        # underscore or camelcase.
default: underscore

*** *** - стиль именования для сгенерированных методов.
...
## 2.2.8. Наименование класса object factory.

cucumber.object-factory=                                      # object factory class name.
example: com.example.MyObjectFactory

*** *** - наименование класса object factory.
...
## 2.2.9. Публикация отчета после выполнения теста
...
## 2.2.10. Запрет баннера публикации отчета после выполнения теста

cucumber.publish.quiet                                        # true or false. default: false
suppress publish banner after test execution

*** *** - запрет баннера публикации отчета после выполнения теста.
...
## 2.2.11. Токен для публикации отчета после выполнения теста

cucumber.publish.token                                        # any string value.
publish authenticated test results

*** *** - токен для публикации отчета после выполнения теста.
