...
## 1.1.1. Количество параллельных потоков при запуске сценариев
...
## 1.1.2. Пакет **Java** с кодом шагов, хуков и т д.
...
## 1.1.4. Фильтрация сценариев по тегам
...
## 1.1.5. Фильтрация сценариев по наименованию                       
...
## 1.1.6. Невыполнение / выполнение кода сценариев
...
## 1.1.7. Черно-белый / цветной вывод терминала
...
## 1.1.8. Соглашение об наименовании для сгенерированных методов 
...
## 1.1.11. Список ключевых слов для определенного языка
...
## 1.1.12. Пропуск сценариев с тегом @wip (**Работа в процессе (Work In Progress**)
...
## 1.1.13. Порядок выполнения сценариев
...
## 1.1.14. Количество выполняемых сценариев
