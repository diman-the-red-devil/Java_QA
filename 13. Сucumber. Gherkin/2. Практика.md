...
## 16.3 Файл RunCucumberTest

***RunCucumberTest*** - класс для запуска сценариев с **JUnit5** и **junit-platform.properties**.
...
## 16.6. Полный код cucumber.properties
