...
![New Maven Project - SmartphonesPageSteps.java](./_Files/2.%20New%20Project/ "New Project - SmartphonesPageSteps.java")
...
![New Maven Project - SmartphoneProductPageSteps.java](./_Files/2.%20New%20Project/ "New Project - SmartphoneProductPageSteps.java")
...
С помощью опций можно указать много разных настроек для запуска сценариев **Cucumber**.
...
Запустится сценарий помеченный тегом **@table2** (из **cucumber.properties**).
...
Запустится сценарий помеченный тегом **@table1** (из **cucumber.properties** значение не будет подтягиваться).

***

# 13. Опции запуска через junit-platform.properties для JUnit 5
...
## 13.2. Полный код POM.xml

[POM.xml](_Sample%20JUnit4/POM.xml)

## 13.3. Файл junit-platform.properties
...
## 13.4. Полный код junit-platform.properties

[junit-platform.properties](_Sample%20JUnit4/src/junit-platform.properties)

## 13.5 Файл RunCucumberJUnit5Test
...
## 13.6. Полный код RunCucumberJUnit5Test.java

[RunCucumberJUnit5Test.java](_Sample%20JUnit4/src/test/java/RunCucumberJUnit5Test.java)

## 13.7. Файл cucumber.properties
...
## 13.8. Полный код cucumber.properties

[cucumber.properties](_Sample%20JUnit4/src/cucumber.properties)

## 13.9. Запуск тестовых сценариев
...
## 15.2. Полный код cucumber.properties

[cucumber.properties](_Sample%20JUnit4/src/cucumber.properties)

## 15.3. Запуск тестовых сценариев
...
## 16.2. Полный код cucumber.properties

[cucumber.properties](_Sample%20JUnit4/src/cucumber.properties)

## 16.3. Запуск тестовых сценариев
