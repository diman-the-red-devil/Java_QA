...
* [5. Список селекторов. Группировка селекторов](#5-список-селекторов-группировка-селекторов)
* [6. Составной селектор. Комбинирование селекторов](#6-составной-селектор-комбинирование-селекторов)
* [7. Сложный селектор. Отношения селекторов](#7-сложный-селектор-отношения-селекторов)
  * [7.1. Селектор X Y](#71-селектор-x-y)
  * [7.2. Селектор X > Y](#72-селектор-x--y)
  * [7.3. Селектор X ~ Y](#73-селектор-x--y)
  * [7.4. Селектор X + Y](#74-селектор-x--y)
