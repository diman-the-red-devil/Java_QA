...
* [1. Драйвер браузера](#1-Драйвер-Браузера)
  * [1.1. Вспомогательный исполняемый файл](#11-вспомогательный-исполняемый-файл)
    * [1.1.1. Куда положить исполняемый файл?](#111-куда-положить-исполняемый-файл)
    * [1.1.2. Как прописать путь до файла?](#112-как-прописать-путь-до-файла)
