...
* [2. Управление исполняемым файлом браузера]()
  * [1.2. Класс DriverService](#12-класс-driverservice)
  * [1.3. Класс DriverService.Builder](#13-класс-driverservicebuilder)
  * [1.4. Реализации DriverService и DriverService.Builder для каждого браузера](#14-реализации-driverservice-и-driverservicebuilder-для-каждого-браузера)
  * [1.5. Совместимость драйверов и браузеров](#15-совместимость-драйверов-и-браузеров)
* [2. WebDriverManager](#2-библиотека-webdrivermanager)
* [3. Команды Selenium WebDriver](#3-команды-selenium-webdriver)
  * [3.1. Интерфейс WebDriver](#31-интерфейс-webdriver)
* [4. Инициализация WebDriver](#4-инициализация-webdriver)
* [5. Паттерн WebDriverFactory](#5-паттерн-webdriverfactory)
* [6. Зачем нужно конфигурировать браузер при старте?](#6-зачем-нужно-конфигурировать-браузер-при-старте)
...
***Selenium WebDriver*** – программная библиотека для управления браузером,
...
* *клиентские библиотеки* для разных языков программирования, предназначенные для управления этими драйверами

Клиентские библиотеки **Selenium WebDriver** доступны на языках:
...
## 2.1. Куда положить исполняемый файл?
...
## 2.2. Как прописать путь до файла?
...
# 3. Управление исполняемым файлом браузера

## 3.1. Класс DriverService 

***DriverService*** - класс для управления исполняемым файлом браузера.
...
### 3.1.1. Класс ChromeDriverService
...
### 3.1.3. Класс InternetExplorerDriverService
...
### 3.1.4. Класс FirefoxDriverService
...
### 3.1.5. Класс GeckoDriverService
...
### 3.1.6. Класс OperaDriverService
...
## 3.2. Класс DriverService.Builder
...
### 3.2.1. Класс ChromeDriverService.Builder
...
### 3.2.2. Класс EdgeDriverService.Builder
...
### 3.2.3. Класс InternetExplorerDriverService.Builder
...
### 3.2.4. Класс FirefoxDriverService.Builder
...
### 3.2.5. Класс GeckoDriverService.Builder
...
### 3.2.6. Класс OperaDriverService.Builder
...
### 3.3.2. Совместимость драйверов браузера Microsoft Edge

| Версия браузера | Версия драйвера     | Производитель драйвера     | 
|-----------------|---------------------|----------------------------|
| последняя       | последняя           | Microsoft - **edgedriver** |

### 3.3.3. Совместимость драйверов браузера Microsoft Internet Explorer
...
### 3.3.4. Совместимость драйверов браузера Mozilla Firefox
...
### 3.3.5. Совместимость драйверов браузера Apple Safari
...
### 3.3.6. Совместимость драйверов браузера Opera
...
### 4.1.1. Открытие и закрытие браузера
...
### 4.1.2. Получение свойств текущей страницы
...
### 4.1.4. Свойства и настройки браузера
...
### 4.1.5. Навигация по истории браузера
...
### 4.1.6. Переходы по вкладкам и окнам браузера
