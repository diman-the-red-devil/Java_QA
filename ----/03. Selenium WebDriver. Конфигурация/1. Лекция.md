...
* **Google Chrome** (**ChromeDriverService** и **ChromeDriverService.Builder**)
...
* **Edge** (**EdgeDriverService** и **EdgeDriverService.Builder**)
...
* **Microsoft Internet Explorer** (**InternetExplorerDriverService** и **InternetExplorerDriverService.Builder**)
...
* **Mozilla Firefox** (**FirefoxDriverService** и **FirefoxDriverService.Builder**)
...
* **Opera** (**OperaDriverService** и **OperaDriverService.Builder**)
...
* *получение свойств текущей страницы*
...
# 6. Зачем нужно конфигурировать браузер при старте?
...
## 7.2 Интерфейс WebDriver.Options
...
## 8.3. Класс ImmutableCapabilities
...
## 8.6. Класс AbstractDriverOptions<DO extends AbstractDriverOptions>
...
### 8.6.1. Класс ChromiumOptions<T extends ChromiumOptions>
...
### 9.1.3. Какие параметры есть у куки?
...
## 9.2. Зачем запускать браузер с cookie?
