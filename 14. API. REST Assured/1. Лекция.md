...
***ResponseBody*** - интерфейс, содержащий методы для  .
...
***ResponseBodyExtractionOptions*** - интерфейс, содержащий методы для  .
...
***ResponseBodyData*** - интерфейс, содержащий методы для  .
...
***ResponseOptions*** - интерфейс, содержащий методы для  .
