...
| Тип     | Метод         | Описание                                                                                          |
|---------|---------------|---------------------------------------------------------------------------------------------------|
| T       | peek()        | Peeks into the JSON that JsonPath will parse by printing it to the console.                       |
...
Извлечение и преобразование данных из тела запроса
...
| Тип         | Метод            | Описание                                                |
|-------------|------------------|---------------------------------------------------------|
| byte[]      | asByteArray()    | Получение данных тела запроса a byte array.             |
| InputStream | asInputStream()  | Получение данных тела запроса input stream.             |
| String      | asPrettyString() | Получение данных тела запроса pretty formatted string.  |
| String      | asString()       | Получение данных тела запроса a string.                 |


| Тип           | Метод            | Описание                              |
|---------------|------------------|---------------------------------------|
| ResponseBody  | body()           | Returns the response body             |
| String        | contentType()    | Get the content type of the response  |
| ResponseBody  | getBody()        | Returns the response body             |
