...
* [7. Паттерн Строитель (Builder)]()
    * [7.1. Класс Smartphone]()
    * [7.2. Полный код Smartphone.java]()
    * [7.3. Класс SmartphoneBuilder]()
    * [7.4. Полный код SmartphoneBuilder.java]()
    * [7.5. Класс SmartphonesProductPage9_Test]()
    * [7.6. Полный код SmartphonesProductPage9_Test.java]()
    * [7.7. Запуск автотеста]()
    * [7.8. Что изменилось и какая польза?]()
* [8. Паттерн Простая Фабрика (SimpleFactory)]()
    * [8.1. Перечисление BrowserName]()
    * [8.2. Полный код BrowserName.java]()
    * [8.3. Класс ChromeBrowser]()
    * [8.4. Полный код ChromeBrowser.java]()
    * [8.5. Класс FirefoxBrowser]()
    * [8.6. Полный код FirefoxBrowser.java]()
    * [8.7. Класс EdgeBrowser]()
    * [8.8. Полный код EdgeBrowser.java]()
    * [8.9. Класс WebDriverFactory]()
    * [8.10. Полный код WebDriverFactory.java]()
    * [8.11. Класс BaseTest2]()
    * [8.12. Полный код BaseTest2.java]()
    * [8.13. Класс SmartphonesProductPage8_Test]()
    * [8.14. Полный код SmartphonesProductPage8_Test.java]()
    * [8.15. Запуск автотеста]()
    * [8.16. Что изменилось и какая польза?]()
...
***Product*** - класс представляющий объект-значение Производитель.

Данный класс реализует интерфейс **java.io.Serializable**.

Шаги:

1. Создать файл **Product.java** в **./src/test/java/models/valueobjects**.

![New Maven Project - Product.java](./_Files/2.%20New%20Project/6.%20Value%20Object/02.jpg "New Project - Product.java")
...
3. Добавить в файл **Product.java** код.
...
[Product.java](_Sample/src/test/java/models/valueobjects/Product.java)
...
[Smartphone.java](_Sample/src/test/java/models/Smartphone.java)
...
[SmartphoneBuilder.java](_Sample/src/test/java/models/SmartphoneBuilder.java)
...
[SmartphonesProductPage9_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage9_Test.java)
...
[BaseTest2.java](_Sample/src/test/java/tests/BaseTest2.java)
...
[SmartphonesProductPage8_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage8_Test.java)
...
## 9.7. Класс SmartphoneProductPageAssert2
...
## 9.8. Полный код SmartphoneProductPageAssert2.java

[SmartphoneProductPageAssert.java](_Sample/src/test/java/tests/smartphones/SmartphoneProductPageAssert2.java)

## 9.9. Класс SmartphonesProductPage10_Test
...
## 9.10. Полный код SmartphonesProductPage10_Test.java

[SmartphonesProductPage10_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage10_Test.java)
