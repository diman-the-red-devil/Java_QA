...
### 5.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + VO + Builder
...
# 4. Паттерн Простая Фабрика (SimpleFactory)
...
### 4.5.1. Фабрика драйверов (WebDriverFactory)
