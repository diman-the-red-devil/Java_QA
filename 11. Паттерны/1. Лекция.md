...
# 2. Простой Java Объект (Plain Old Java Object (POJO))
...
### 2.5.1. UI автотесты с POM + PE + AAA + Matchers + POJO
...
### 3.5.1. UI автотесты с POM + PE + AAA + Matchers + JB
...
# 4. Объект Значение (Value Object (VO))
...
## 4.5. Применение в автотестах

### 4.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + VO
...
### 5.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + EO + VO

#### 5.5.1.1. До применения паттерна

1. *Класс учетных данных - Account*
...
# 6. Объект передачи данных (Data Transfer Object)
...
## 6.5. Применение в автотестах

### 6.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + EO + VO + DAO
...
2. *Класс для передачи учетных данных - AccountDAO*
...
#### 3.1.5.3. Фабрика тестовых данных
...
#### 3.3.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + VO + Builder
...
![Структурные паттерны](./_Files/1.%20Patterns/20.webp "Структурные паттерны")
...
***Поведенческие паттерны*** - паттерны проектирования, в которых рассматривается вопрос 
эффективного и безопасного взаимодействия между объектами программы.

![Поведенческие паттерны](./_Files/1.%20Patterns/29.jpg "Поведенческие паттерны")

Поведенческие шаблоны связаны с распределением обязанностей между объектами. 
...
#### 5.1.5.1. Цепочка вызовов методов объектов страниц
