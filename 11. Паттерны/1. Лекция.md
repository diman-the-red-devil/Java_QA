...
***Паттерн проектирования или шаблон*** в разработке программного обеспечения —
...
#### 2.1.5.1. UI автотесты с POM + PE + AAA + Matchers + POJO
...
#### 2.2.5.1. UI автотесты с POM + PE + AAA + Matchers + JB
...
#### 2.3.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + VO
...
#### 2.4.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + EO + VO
...
#### 2.5.5.1. UI автотесты с POM + PE + AAA + Matchers + JB + EO + VO + DAO
