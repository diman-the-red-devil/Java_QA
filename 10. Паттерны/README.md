...
* [6. Паттерн Подготовка, Действие, Проверка (Arrange Act Assert)](2.%20Практика.md#6-паттерн-подготовка-действие-проверка-arrange-act-assert)
	...
	* [6.2. Секции Arrange Act Assert](2.%20Практика.md#62-секции-arrange-act-assert)
	* [6.3. Полный код Pattern3AAATest.java](2.%20Практика.md#63-полный-код-pattern3aaatestjava)
	* [6.4. Запуск автотеста](2.%20Практика.md#64-запуск-автотеста)
	* [6.5. Что изменилось и какая польза?](2.%20Практика.md#65-что-изменилось-и-какая-польза)
