...
* [2. Классы-помощники (Helpers)](#2-классы-помощники-helpers)
  * [2.1. Класс WaitFor](#21-класс-waitfor)
  * [2.2. Полный код WaitFor.java](#22-полный-код-waitforjava)
  * [2.3. Класс JSExec](#23-класс-jsexec)
  * [2.4. Полный код JSExec.java](#24-полный-код-jsexecjava)
* [3. Тесты](#3-тесты)
...
* [4. Паттерн Объект страницы / Объектная модель страницы (Page Object / Page Object Model (POM))](#4-паттерн-объект-страницы--объектная-модель-страницы-page-object--page-object-model-pom)
  ...
  * [4.9. Класс SmartphonesProductPage1_Test](#49-класс-smartphonesproductpage1_test)
  * [4.10. Полный код SmartphonesProductPage1_Test.java](#410-полный-код-smartphonesproductpage1_testjava)
  * [4.11. Запуск автотеста](#411-запуск-автотеста)
* [5. Паттерн Подготовка, Действие, Проверка (Arrange Act Assert)](#5-паттерн-подготовка-действие-проверка-arrange-act-assert)
  * [5.1. Класс SmartphonesProductPage2_Test](#51-класс-smartphonesproductpage2_test)
  * [5.2. Секции Arrange Act Assert](#52-секции-arrange-act-assert)
  * [5.3. Полный код SmartphonesProductPage2_Test.java](#53-полный-код-smartphonesproductpage2_testjava)
  * [5.4. Запуск автотеста](#54-запуск-автотеста)
* [6. Паттерн Матчеры (Assert Objects / Matchers)](#6-паттерн-матчеры-assert-objects--matchers)
  * [6.1. Класс SmartphonesProductPage3_Test](#61-класс-smartphonesproductpage3_test)
  * [6.2. Класс SmartphoneProductPageAssert](#62-класс-smartphoneproductpageassert)
  * [6.3. Полный код SmartphoneProductPageAssert.java](#63-полный-код-smartphoneproductpageassertjava)
  * [6.4. Полный код SmartphonesProductPage3_Test.java](#64-полный-код-smartphonesproductpage3_testjava)
  * [6.5. Запуск теста](#65-запуск-теста)
* [7. Паттерн Элементы страницы (Page Elements)](#7-паттерн-элементы-страницы-page-elements)
  * [7.1. Класс BaseElement](#71-класс-baseelement)
  * [7.2. Полный код BaseElement.java](#72-полный-код-baseelementjava)
  * [7.3. Класс Button](#73-класс-button)
  * [7.4. Полный код Button.java](#74-полный-код-buttonjava)
  * [7.5. Класс TextBox](#75-класс-textbox)
  * [7.6. Полный код TextBox.java](#76-полный-код-textboxjava)
  * [7.7. Класс CheckBox](#77-класс-checkbox)
  * [7.8. Полный код CheckBox.java](#78-полный-код-checkboxjava)
  * [7.9. Класс RadioButton](#79-класс-radiobutton)
  * [7.10. Полный код RadioButton.java](#710-полный-код-radiobuttonjava)
  * [7.11. Класс Link](#711-класс-link)
  * [7.12. Полный код Link.java](#712-полный-код-linkjava)
  * [7.13. Класс Accordeon](#713-класс-accordeon)
  * [7.14. Полный код Accordeon.java](#714-полный-код-accordeonjava)
  * [7.15. Класс MainBlock](#715-класс-mainblock)
  * [7.16. Полный код MainBlock.java](#716-полный-код-mainblockjava)
  * [7.17. Класс StartPageWithElements](#717-класс-startpagewithelements)
  * [7.18. Полный код StartPageWithElements.java](#718-полный-код-startpagewithelementsjava)
  * [7.19. Класс SmartphonesPageWithElements](#719-класс-smartphonespagewithelements)
  * [7.20. Полный код SmartphonesPageWithElements.java](#720-полный-код-smartphonespagewithelementsjava)
  * [7.21. Класс SmartphonesProductPage4_Test](#721-класс-smartphonesproductpage4_test)
  * [7.22. Полный код SmartphonesProductPage4_Test.java](#722-полный-код-smartphonesproductpage4_testjava)
  * [7.23. Запуск теста](#723-запуск-теста)
...
1. Создать файл **WaitFor.java** в **./src/test/java/helpers**.

![New Maven Project - WaitFor.java](./_Files/2.%20New%20Project/2.%20Helpers/02.jpg "New Project - WaitFor.java")
...
[WaitFor.java](_Sample/src/test/java/helpers/WaitFor.java)
...
![New Maven Project - JSExec.java](./_Files/2.%20New%20Project/2.%20Helpers/03.jpg "New Project - JSExec.java")
...
* метод **initJS** - инициализация исполнителя JS скриптов
...
[JSExec.java](_Sample/src/test/java/helpers/JSExec.java)
...
![New Maven Project - SmartphonesProductPage1_Test.java](./_Files/2.%20New%20Project/4.%20Page%20Object%20Model/07.jpg "New Project - SmartphonesProductPage1_Test.java")

3. Добавить в файл **SmartphonesProductPage1_Test.java** код.

* метод **filterBySamsung8Gb_sortByExpansiveFirst_Test** - тест
...
## 4.10. Полный код SmartphonesProductPage1_Test.java

[SmartphonesProductPage1_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage1_Test.java)
...
![New Maven Project - SmartphonesProductPage2_Test.java](./_Files/2.%20New%20Project/5.%20Arrange%20Act%20Assert/01.jpg "New Project - SmartphonesProductPage2_Test.java")
...
public void filterBySamsung8Gb_sortByExpansiveFirst_Test() {
    ...
    JSExec.scrollBy(0, -1500);
    // Нажатие на ссылку первого продукта в списке
    smartphonesPage.linkProductClick("Смартфон Samsung Galaxy S22+ 256 ГБ розовый");
    SmartphoneProductPage smartphoneProductPage = new SmartphoneProductPage(driver);
    String actual = smartphoneProductPage.getPageTitle();
...
[SmartphonesProductPage2_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage2_Test.java)
...
![New Maven Project - Запуск теста](./_Files/2.%20New%20Project/5.%20Arrange%20Act%20Assert/02.jpg "New Maven Project - Запуск теста")

2. Готово!

В результате будет выполнен тест.

![New Maven Project - Запуск теста](./_Files/2.%20New%20Project/5.%20Arrange%20Act%20Assert/03.jpg "New Maven Project - Запуск теста")

В консоли будет выведен лог запуска.

![New Maven Project - Лог запуска](./_Files/2.%20New%20Project/5.%20Arrange%20Act%20Assert/04.jpg "New Maven Project - Лог запуска")
...
![New Maven Project - SmartphonesProductPage3_Test.java](./_Files/2.%20New%20Project/6.%20Assert%20Objects%20-%20Matchers/01.jpg "New Project - SmartphonesProductPage3_Test.java")
...
![New Maven Project - SmartphonesAssert.java](./_Files/2.%20New%20Project/6.%20Assert%20Objects%20-%20Matchers/02.jpg "New Project - SmartphoneProductPageAssert.java")
...
[SmartphoneProductPageAssert.java](_Sample/src/test/java/tests/smartphones/SmartphoneProductPageAssert.java)

## 6.4. Полный код SmartphonesProductPage3_Test.java

[SmartphonesProductPage3_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage3_Test.java)
...
![New Maven Project - Запуск теста](./_Files/2.%20New%20Project/6.%20Assert%20Objects%20-%20Matchers/03.jpg "New Maven Project - Запуск теста")

2. Готово!

В результате будет выполнен тест.

![New Maven Project - Запуск теста](./_Files/2.%20New%20Project/6.%20Assert%20Objects%20-%20Matchers/04.jpg "New Maven Project - Запуск теста")

В консоли будет выведен лог запуска.

![New Maven Project - Лог запуска](./_Files/2.%20New%20Project/6.%20Assert%20Objects%20-%20Matchers/05.jpg "New Maven Project - Лог запуска")
...
![New Maven Project - elements](./_Files/2.%20New%20Project/7.%20Page%20Elements/01.jpg "New Project - elements")
...
![New Maven Project - BaseElement.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/02.jpg "New Project - BaseElement.java")
...
![New Maven Project - Button.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/03.jpg "New Project - Button.java")
...
![New Maven Project - TextBox.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/04.jpg "New Project - TextBox.java")
...
![New Maven Project - CheckBox.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/05.jpg "New Project - CheckBox.java")
...
![New Maven Project - RadioButton.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/06.jpg "New Project - RadioButton.java")
...
![New Maven Project - Link.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/07.jpg "New Project - Link.java")
...
![New Maven Project - Accordeon.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/08.jpg "New Project - Accordeon.java")
...
![New Maven Project - MainBlock.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/09.jpg "New Project - MainBlock.java")
...
[MainBlock.java](_Sample/src/test/java/elements/MainBlock.java)
...
***StartPageWithElements*** - класс моделирующий объекты **Стартовой страницы** сайта 
...
![New Maven Project - StartPage.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/10.jpg "New Project - StartPage.java")
...
[StartPageWithElements.java](_Sample/src/test/java/pages/StartPageWithElements.java)
...
![New Maven Project - SmartphonesPageWithElements.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/11.jpg "New Project - SmartphonesPageWithElements.java")
...
[SmartphonesPageWithElements.java](_Sample/src/test/java/pages/SmartphonesPageWithElements.java)
...
![New Maven Project - SmartphonesProductPage3_Test.java](./_Files/2.%20New%20Project/7.%20Page%20Elements/12.jpg "New Project - SmartphonesProductPage3_Test.java")
...
[SmartphonesProductPage4_Test.java](_Sample/src/test/java/tests/smartphones/SmartphonesProductPage4_Test.java)
...
![New Maven Project - Запуск теста](./_Files/2.%20New%20Project/7.%20Page%20Elements/13.jpg "New Maven Project - Запуск теста")

2. Готово!

В результате будет выполнен тест.

![New Maven Project - Запуск теста](./_Files/2.%20New%20Project/7.%20Page%20Elements/14.jpg "New Maven Project - Запуск теста")

В консоли будет выведен лог запуска.

![New Maven Project - Лог запуска](./_Files/2.%20New%20Project/7.%20Page%20Elements/15.jpg "New Maven Project - Лог запуска")
