...
## 4.1. Слушатель в Selenium 3

Шаги:

1. Создать файл **Selenium3Listener.java** в **./src/test/java**.

![New Maven Project - Selenium3Listener.java](./_Files/2.%20New%20Project/33.jpg "New Maven Project - Selenium3Listener.java")
...
![New Maven Project - ListenersTest.java](./_Files/2.%20New%20Project/34.jpg "New Maven Project - ListenersTest.java")
...
## 4.2. Слушатель в Selenium 4

Шаги:

1. Создать файл **Selenium4Listener.java** в **./src/test/java**.

![New Maven Project - Selenium4Listener.java](./_Files/2.%20New%20Project/37.jpg "New Maven Project - Selenium4Listener.java")
...
![New Maven Project - Лог запуска](./_Files/2.%20New%20Project/39.jpg "New Maven Project - Лог запуска")
