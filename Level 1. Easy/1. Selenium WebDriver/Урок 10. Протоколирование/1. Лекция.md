...
## 1.1. Как работают современные веб приложения?
...
При работе приложения надо понимать, что вообще происходит внутри него, особенно при разборе ошибок и инцидентов.
...
### 1.1.2. Чем полезны логи в автотестах Selenium WebDriver?

При работе автотестов **Selenium WebDriver** очень часто необходимо знать какие запросы были отправлены после какого либо действия

### 1.1.3. Как можно получить логи в Selenium WebDriver?

В **Selenium WebDriver** получить логи можно с помощью встроенных классов и интерфейсов.
...
При работе в **Selenium** часто приходится делать скриншот веб-страницы или ее части, 
до или после выполнения кого либо действия или события на странице.
...
Есть несколько способов сделать скриншот в **Selenium WebDriver**:
...
Для записи видео можно воспользоваться следующими способами:
...
# 6. Запись видео с Monte Screen Recorder
