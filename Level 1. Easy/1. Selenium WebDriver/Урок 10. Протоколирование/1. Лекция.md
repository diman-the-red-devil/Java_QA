...
Сообщение содержит основную информацию о действиях пользователя
или о работе программы.
...
Для поддержки таких ситуаций есть возможность конфигурировать логгирование как отдельная настройка в **Selenium WebDriver**.
