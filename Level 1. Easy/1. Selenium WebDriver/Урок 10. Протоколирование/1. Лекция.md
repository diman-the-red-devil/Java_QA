...
### 2.1.1. Скриншот видимой области страницы
...
### 2.1.2. Скриншот веб элемента вырезанный из видимой области


*Пример*

```java
WebElement element = driver.findElement(By.xpath("//a[text()=\"Да\"]"));
...
try {
    ...
    BufferedImage elementImage = pageImage.getSubimage(x, y, w, h);
