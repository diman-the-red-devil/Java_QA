...
* с помощью стандартных классов и интерфейсов **Selenium WebDriver**
...
## 2.2. Печать страницы в PDF

### 2.2.1. Интерфейс PrintsPage
...
### 2.2.4. Перечисление PrintOptions.Orientation
...
### 2.3.3. Интерфейс SessionStorage
...
# 3. Выполнение JS скрипта

## 3.1. Интерфейс JavascriptExecutor
...
## 3.2. Решение простых задач с помощью выполнения JS

### 3.2.1. Клик на веб элемент
...
### 3.2.2. Получение текста веб элемента
...
## 5.1. Работа с файлом формата PDF

### 5.1.1. Библиотека Apache PdfBox
...
## 5.2. Работа с файлами формата Excel
...
## 6.4. Отображение скрытых элементов
...
## 6.5. Проверка цвета веб элемента
...
## 6.7. Извлечение текста из документа PDF
