...
# 1. Команды Selenium WebDriver

## 1.1. Решение задач с помощью команд Selenium WebDriver

### 1.1.1. Отправление файла
...
### 2.2.4. Отображение скрытых элементов
