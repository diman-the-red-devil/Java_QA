...
## 2.2. Решение задач с помощью JS
...
## 4.3. Перечисление PrintOptions.Orientation
...
| Тип    | Метод        | Описание            | 
|--------|--------------|---------------------|
| String | getContent() | Получение файла PDF |
