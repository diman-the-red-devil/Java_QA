...
[selenium/docs/api : MutableCapabilities](https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/remote/DesiredCapabilities.html)
...
Непосредственно от AbstractDriverOptions наследуются классы Options для управления различными свойствами конкретного браузера. 
...
***ChromiumOptions*** - класс для управления различными свойствами браузера **Chromium**.
...
***ChromeOptions*** - класс для управления различными свойствами браузера **Google Chrome**.
...
[selenium/docs/api : ChromeOptions](https://chromedriver.chromium.org/capabilities)
...
***FirefoxOptions*** - класс для управления различными свойствами браузера **Mozilla Firefox**.
...
***OperaOptions*** - класс класс для управления различными свойствами браузера **Opera**.
