...
## 3. Capabilities, MutableCapabilities, DesiredCapabilities и AbstractDriverOptions

Каждый браузер обладает какими либо свойствами, отличными от других браузеров.
В автотестах бывает полезно использовать эти свойства браузеров.
Для настройки специфичных свойств существуют специальные интерфейсы и классы под каждый браузер.

### Интерфейс Capabilities

**Capabilities** - интерфейс для получения свойств конкретного браузера.
...
| DesiredCapabilities | merge​(Capabilities extraCapabilities)               | мерж настроек                               |
...
Непосредственно от AbstractDriverOptions наследуются классЫ Options для управления различными свойствами драйвера конкретного браузера. 
