...
# 2. Основыне команды Selenium WebDriver
...
* *Поиск веб элементов на странице*
...
Управлять навигацией можно с помощью **WebDriver.Options**.
...
## 3.2. Интерфейс WebDriver.Navigation
...
Готово! Теперь при изменении параметров запуска браузера (к примеру, требуется добавить Cookie), 
