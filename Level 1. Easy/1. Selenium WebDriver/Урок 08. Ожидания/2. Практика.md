...
1. Добавить в файл **ExplicitWaitsTest.java** код.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementStateExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementPresenceExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementStalenessExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementVisibilityExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementInvisibilityExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementTextExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#pageExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#alertExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#frameExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#windowsExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#jsScriptExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#logicalExpectedConditionTest**.
...
![New Maven Project - CustomExpectedConditionTest.java](./_Files/5.%20New%20Project/09.jpg "New Maven Project - CustomExpectedConditionTest.java")
...
* вложенный класс **CustomExpectedConditionTest**, реализующий интерфейс **ExpectedCondition**
...
![New Maven Project - Запуск теста](./_Files/5.%20New%20Project/48.jpg "New Maven Project - Запуск теста")
...
![New Maven Project - Лог запуска](./_Files/5.%20New%20Project/49.jpg "New Maven Project - Лог запуска")

## 5.2. Анонимный класс

Шаги:

1. Добавить в файл **CustomExpectedConditionTest.java** код.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#anonymousClassTest**.

![New Maven Project - Запуск теста](./_Files/5.%20New%20Project/50.jpg "New Maven Project - Запуск теста")
...
![New Maven Project - Лог запуска](./_Files/5.%20New%20Project/51.jpg "New Maven Project - Лог запуска")
...
![New Maven Project - CustomExpectedConditionTest.java](./_Files/5.%20New%20Project/52.jpg "New Maven Project - FluentWaitTest.java")
...
![New Maven Project - Запуск теста](./_Files/5.%20New%20Project/53.jpg "New Maven Project - Запуск теста")
...
![New Maven Project - Лог запуска](./_Files/5.%20New%20Project/54.jpg "New Maven Project - Лог запуска")
