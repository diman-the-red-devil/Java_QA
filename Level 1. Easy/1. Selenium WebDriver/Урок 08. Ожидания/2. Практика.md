...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=ExplicitWaitsTest#elementsNumberExpectedConditionTest**.
...
2. Запустить тест командой **mvn clean test** с параметром **-Dtest=CustomExpectedConditionTest#anonymousClassTest**.
