...
## 2.1. Свойства окна браузера

# 2.2.1. Интерфейс WebDriver
...
## 2.2.2. Интерфейс WebDriver.Options
...
## 2.2.3. Интерфейс WebDriver.Window
...
| Тип         | Метод              | Описание                         | 
|-------------|--------------------|----------------------------------|
| String      | getWindowHandle()  | Получение дескриптора окна       |
| Set<String> | getWindowHandles() | Получение дескрипторов всех окон |
...
## 4.2. Интерфейс WebDriver.TargetLocator
...
### 4.2.1. Активный элемент

| WebElement	| activeElement()                | Switches to the element that currently has focus within the document currently "switched to", or the body element if this cannot be detected.

### 4.2.2. Модалки (Alert, Prompt, Confirm)

| Alert	        | alert()                        | Switches to the currently active modal dialog for this particular driver instance.

#### 4.2.2.1. Интерфейс Alert
