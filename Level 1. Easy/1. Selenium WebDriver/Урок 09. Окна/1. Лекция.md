...
#### 6.2.1.1. Переключение на существующее окно / вкладки
...
Как уже упоминалось выше, поиск элементов в **Selenium** осуществляется опираясь 
...
Для этого используется метод **frame**.
...
если окна с заданным именем не найден. 
