...
**Селектор X ~ Y** предназначен для выбора элементов *Y* расположенных после *X*, которые должны быть по отношению друг к другу соседями (сиблингами).
...
**Селектор X + Y** предназначен для выбора элементов *Y* расположенных сразу же после *X*, которые должны быть по отношению друг к другу соседями (сиблингами).
...
Селектор **div + p** выберет любой *p* элемент, который находится непосредственно после элемента *div*.