...
### 6.2. Левый клик мышью c удержанием
...
### 6.6. Нажатие и отпускание клавиши клавиатуры
...
### 6.8. Перемещение мыши на элемент
...
### 6.9. Отпускание левой кнопки мыши
...
### 7.1. StaleElementReferenceException
...
### 7.2. ElementClickInterceptedException
...
### 7.3. ElementNotInteractableException
...
### 7.4. ElementNotVisibleException
...
### 7.5. ElementNotSelectableException
...
### 7.6. InvalidElementStateException
...
### 7.7. InvalidCoordinatesException
...
### 7.8. MoveTargetOutOfBoundsException
