...
## 3.3. Удаление текста из поля ввода
...
### 5.2.2. clickAndHold(WebElement target)
...
### 5.3.2. contextClick(WebElement target)
...
### 5.4.2. doubleClick(WebElement target)
...
### 5.5.1. dragAndDrop(WebElement source, WebElement target)
...
### 5.5.2. dragAndDropBy(WebElement source, int xOffset, int yOffset)
...
### 5.6.1. keyDown(Keys key) / keyUp(Keys key)
...
### 5.6.2. keyDown(WebElement target, Keys key) / keyUp(WebElement target, Keys key)
...
#### 5.6.3.2. Модификационные клавиши
...
#### 5.6.3.3. Арифметические клавиши
...
#### 5.6.3.5. Функциональные клавиши
...
### 5.7.1. moveByOffset(int xOffset, int yOffset)
...
### 5.8.1. moveToElement(WebElement toElement)
...
### 5.8.2. moveToElement(WebElement toElement, int xOffset, int yOffset)
...
### 5.9.2. release(WebElement onElement)
