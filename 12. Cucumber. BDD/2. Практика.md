...
## 3.4. Полный код POM.xml

[POM.xml](_Sample JUnit4/pom.xml)
...
[WebDriverFactory.java](_Sample JUnit4/src/test/java/web/drivers/WebDriverFactory.java)
...
[DriverHooks.java](_Sample JUnit4/src/test/java/hooks/DriverHooks.java)
...
[DriverHooks.java](_Sample JUnit4/src/test/java/hooks/ScreenShotHooks.java)
...
[Smartphone.feature](_Sample JUnit4/src/test/resources/features/smartphone.feature)
...
## 8.2. Полный код SmartphoneSteps.java

[SmartphoneSteps.java](_Sample JUnit4/src/test/java/steps/SmartphoneSteps.java)
...
## 8.4. Полный код SmartphoneProductPageSteps.java

[SmartphoneProductPageSteps.java](_Sample JUnit4/src/test/java/steps/SmartphoneProductPageSteps.java)
...
[RunCucumberTest.java](_Sample JUnit4/src/test/java/RunCucumberTest.java)
...
[POM.xml](_Sample JUnit5/pom.xml)
...
[RunCucumberTest.java](_Sample JUnit5/src/test/java/RunCucumberTest.java)
