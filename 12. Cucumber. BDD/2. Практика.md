...
![New Maven Project - Project](./_Files/2.%20New%20Project/01.jpg "New Project - Project")

В общем случае может быть любая конфигурация пакетов и папок с файлами.

## 3.1. Папки и пакеты

### 3.1.1. Пакеты с .java файлами
...
## 5.1. Класс SmartphoneProductPage (Страница "Продукт. Смартфон")
...
## 5.2. Полный код SmartphoneProductPage.java
