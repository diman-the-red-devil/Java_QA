...
public class Pattern11WFTest extends BaseTestWF {
    ...
    public void dnsTest() {
        ...
        // 2. Act
        SmartphoneProductPageSteps smartphoneProductPage = getProductPage(smartphone);
    ...
    public SmartphoneProductPageSteps getProductPage(Smartphone smartphone) {
        ...
        smartphonesPage.filterByCompany(smartphone.getCompany().getCompany());
        // Установка фильтра "Объем оперативной памяти"
        smartphonesPage.filterByRAM(smartphone.getRam().getRam());
        // Применение фильтров
